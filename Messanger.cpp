...
int main(int argc, char *argv[]) {
    ...
    app.mainlayer.addFigure(Figure("main-title", "circled-rectangle", {0, 0}, app.res, {200, 200, 200}));
    ...
    app.getLayer("title-front").getInputField("title-front-login").setFigure(Figure("imp", "circled-rectangle", {0, 0}, {0, 0}, {50, 50, 50}));
    ...
    app.getLayer("title-front").getInputField("title-front-password").setFigure(Figure("imp", "circled-rectangle", {0, 0}, {0, 0}, {50, 50, 50}));
    ...
    app.getLayer("title-front").getButton("title-front-login-button").setFigure(Figure("imp", "circled-rectangle", {0, 0}, {0, 0}, {0, 0, 0}));
